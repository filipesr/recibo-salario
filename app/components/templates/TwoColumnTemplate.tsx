  ...
  return (
    <div className="w-full max-w-5xl bg-sky-50 p-6 print-full-width">
      <div className="grid grid-cols-[1fr,2fr] gap-4 print:grid-cols-[1fr,2fr]">
        ...
        <div className="bg-white border-2 border-cyan-400 rounded-lg p-3 space-y-2 text-sm">
          <div className="text-xs">
            <span className="text-cyan-600 font-semibold">Recibo Nº: </span>
            <span className="border-b border-cyan-300">{data.numero || '______'}</span>
          </div>

          <div className="text-xs">
            <span className="text-cyan-600 font-semibold">Valor: </span>
            <span className="border-b border-cyan-300">{data.valor || '_____'}</span>
          </div>

          <div className="text-xs">
            <span className="text-cyan-600 font-semibold">Recebi de: </span>
            <span className="border-b border-cyan-300">{data.pagador || '______'}</span>
          </div>

          <div className="text-xs">
            <span className="text-cyan-600 font-semibold">Endereço: </span>
            <span className="border-b border-cyan-300">{data.pagadorEndereco || '______'}</span>
          </div>

          <div className="text-xs">
            <span className="text-cyan-600 font-semibold">A importância de: </span>
            <span className="border-b border-cyan-300">{data.valorExtenso || '______'}</span>
          </div>

          <div className="text-xs">
            <span className="text-cyan-600 font-semibold">Referente: </span>
            <span className="border-b border-cyan-300">{data.referente || '______'}</span>
          </div>

          <div className="pt-2">
            <div className="border-b border-cyan-300 py-0.5 text-xs text-center">
        ...
        <div className="bg-white border-2 border-cyan-400 rounded-lg p-4">
          ...
          <div className="grid grid-cols-[auto,1fr,auto] gap-3 items-start mb-3">
            <div className="border border-cyan-400 rounded px-2 py-1">
          ...
          <div className="border-2 border-cyan-400 rounded p-2 space-y-1.5">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="text-sm">
                <span className="text-cyan-600 font-semibold">CPF/RG: </span>
